...
const BookingManagement = () => {
  ...
  const executeStatusChange = async (bookingId, newStatus, booking) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/admin/update_booking_status.php`, {
        method: 'POST',
  ...
  const handlePaymentStatusChange = async (bookingId, newPaymentStatus) => {
    try {
      const response = await fetch(`${API_BASE_URL}/admin/update_payment_status.php`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          booking_id: bookingId,
  ...
  const executeDeleteBooking = async (bookingId, bookingCode) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/admin/delete_booking.php`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          booking_id: bookingId
  ...
  const executeConfirmLateReturn = async () => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/admin/confirm_late_return.php`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
