...
try {
    ...
    if ($user) {
        ...
        // User baru, insert ke database (phone & identity_card_number = empty string untuk Google OAuth users)
        $stmt = $pdo->prepare("INSERT INTO customers (name, email, phone, identity_card_number, google_id) VALUES (?, ?, ?, ?, ?)");
